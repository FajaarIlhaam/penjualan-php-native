            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a href="logoutt.php" onclick="javascript: return confirm('Yakin Ingin Logout ?');" class="tree-toggle nav-header"><span class="fa fa-sign-out"></span> Logout  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    </li>
                  </ul>
                </div>
            </div>
            ...
            <div id="content">
                ...
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tambah </h3>
