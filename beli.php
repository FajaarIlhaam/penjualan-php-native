          ...
          <!-- start:Left Menu -->
            ...
            <div id="content">
				...
				while ($r=mysqli_fetch_array($data)) {
					?>
                        <form method="POST" action="pro_beli.php">
                         ...
                         <input type="hidden" name="id" value="<?php echo $r['id']; ?>">
                          <div class="col-md-12">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Transaksi</label>
                              <div class="col-sm-10">
                                <input name="nama_transaksi" type="text" class="form-control" required ></div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Harga</label>
                              <div class="col-sm-10">
                                <input name="harga_satuan" type="text" class="form-control" value="<?php echo $r['harga'];?>" require=""></div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Jumlah</label>
                              <div class="col-sm-10">
                                <input name="qty" type="number" class="form-control" required ></div>
                            </div>
                             <br><br>
                            <div class="col-md-8">        
                                <input  type="submit" class="btn btn-gradient btn-primary align-center" 
                                value="Beli" name="bayar"/>
                            </div>
                            <br><br>
                        </div>
                    </div>
