 ...
 <body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a href=""><span class="fa fa-table"></span> Tables  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    </li>
          ...
          <div class="col-md-12 top-20 padding-0">
            <div class="col-md-12">
              <div class="panel">
                <div class="panel-heading"><h3>Data Barang</h3></div><br>
                <div class="col-md-8">  
                <a href ="tambahbarang.php">      
                <input  type="button" class=" btn btn-gradient btn-primary" value="Tambah Barang"/>
                </a>
                </div><br><br>
                <div class="panel-body">
                  ...
                  <?php
                    ...
                    $sql="SELECT * FROM jual ORDER BY nama_barang";
             ...
             <td><?php echo $no++ ?></td>
			 	...
			 	<td><a href='editbarang.php?id=<?php echo $r['id'];?>'>Edit</a></td>
				<td><a href='hapus.php?id=<?php echo $r['id'];?>'onclick="return confirm('Anda yakin ingin Menghapus Data ini dengan permanen?')">Hapus</a></td>
                    </tr>
            <?php
                    }
                ?>      
